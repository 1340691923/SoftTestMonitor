...
var manuallyQueryScoreCmd = &cobra.Command{
	...
	Short: "手动查询分数",
	Long: `手动查询分数功能  config.json 配置文件中所需参数： 0.year->考试时间(建议查询之前先执行showExaminationTimeCmd 查看所有考试时间),
...
4.send_user_163_mail_address->邮件发送者163用户账号,5.send_user_163_mail_auth_code->邮件发送者163邮箱授权码,6.receive_user_163_mail_address->邮件接收者邮箱地址
`,
